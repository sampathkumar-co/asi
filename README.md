...
| **2** | Scientific-method / verification | **vNext frozen + fresh holdout preregistration pending CI - NOT CERTIFIED** |
...
Post-v31 development hardens execution integrity before any new candidate freeze: provider/transport and trusted-runner failures now invalidate the campaign instead of becoming ordinary arm zeros. Task-independent purpose-specific JSON Schemas constrain normal Gate-2 Ollama calls without encoding scientific IDs or answers, and a task-independent provider preflight aborts before scored evidence on provider failure. Schema recovery is now bounded to **two repair calls total per arm**, shared across stages and verifiers; a third repair is impossible. Current validation is **181/181** tests and **59/59** Gate-2 canaries, with qualification hash `7df14fe831d3d1f5b5f247bb3e244080763e955b139c377ed06f4c833dc88fde` and implementation digest `56707e7012af796b21c0304d6f2b3f4a903b95655dee28abd4181cc9a308bdf3`. The exact-candidate eight-task public-development run at source commit `62bf1db71f329abc095d8122214c551f3e1a9cd7` sealed 8/8 clean pairs with Raw **0.80000**, Seed **0.98750**, gain **+0.18750**, strict wins **87.5%**, CI **[+0.090625, +0.31875]**, **100%** verifier acceptance, zero repairs, and zero execution incidents. Every frozen numerical criterion passes except the public suite's intentional 8-vs-16 pair-count limit. See [`docs/GATE2_VNEXT_FINAL_PUBLIC_RESULT.md`](docs/GATE2_VNEXT_FINAL_PUBLIC_RESULT.md). This remains development evidence only and no retired holdout is reused. The unchanged vNext candidate is now frozen at `ce67ac5517115af85b0ce5b424426d0c1a1d351f` with green freeze CI #162; a fresh external 18-pair holdout was created and audited afterward with no inference. Its preregistration is [`docs/GATE2_PRIVATE_HOLDOUT_VNEXT_PREREGISTRATION.md`](docs/GATE2_PRIVATE_HOLDOUT_VNEXT_PREREGISTRATION.md), and private inference must wait for green CI on that preregistration commit.
